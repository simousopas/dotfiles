...
- Configure _Accessibility_
  ...
  - Under _Pointer Control_, _Trackpad Options_, enable `Three Finger Drag` and
...
- Configure _Privacy & Security_
  - Under _Location Services_, _System Service_, disable location access for
...
- Configure _Keyboard_
  ...
  - Assign _Escape_ to the _Caps Lock_ key.
...
- Clone this repository and run `./bootstrap.sh`. Manual password input will be
  required a couple of times during the process.
