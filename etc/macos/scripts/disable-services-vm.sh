...
# NOTE: This script is specially targeted for macOS virtual machines.
# It contains the largest set of macOS services to be disabled when compared to
# `disable-services.sh` or `disable-services-oclp.sh`.
